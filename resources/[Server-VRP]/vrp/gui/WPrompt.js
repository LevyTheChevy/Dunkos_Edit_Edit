...
WPrompt.prototype.open = function(title,text)
{
  ...
  // this.div.style.left = Math.round(document.body.offsetWidth-this.div.offsetWidth-100)+"px";
  // this.div.style.top = Math.round(document.body.offsetHeight-20-anchor_index*22)+"px";
