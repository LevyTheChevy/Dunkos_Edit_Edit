...
ProgressBar.prototype.frame = function(time)
{
 ...
 var width = cfg.anchor_minimap_width/anchor.length; //divide horizontal map space by number of pbars
        ...
        //set size
        this.div.style.width = this.div_label.style.width = (75)+"px";
        this.div_inner.style.height = this.div.style.height = this.div_label.style.height = (0)+"px";
        this.div_label.style.lineHeight = this.div_label.style.height;
        ...
        this.div.style.top = (document.body.offsetHeight-20-anchor_index*22)+"px";
      }
      else if(anchor_name == "center"){ //CENTER
        //set size
        this.div.style.width = this.div_label.style.width = (700)+"px";
        this.div_inner.style.height = this.div.style.height = this.div_label.style.height = (0)+"px";
        this.div_label.style.lineHeight = this.div_label.style.height;

        //set label font size
        this.div_label.style.fontSize = "1.5em";
