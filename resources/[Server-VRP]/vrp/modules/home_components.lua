...
local function chest_create(owner_id, stype, sid, cid, config, x, y, z, player)
  ...
  vRPclient.setNamedMarker(player,{nid,x,y,z-1,0.8,0.8,0.3,255,255,255,125,150})
...
local function wardrobe_create(owner_id, stype, sid, cid, config, x, y, z, player)
  ...
  vRPclient.setNamedMarker(player,{nid,x,y,z-1,0.5,0.5,0.3,153,110,73,125,150})
...
local function gametable_create(owner_id, stype, sid, cid, config, x, y, z, player)
  ...
  vRPclient.setNamedMarker(player,{nid,x,y,z-1,0.9,0.9,0.3,0,0,0,125,150})
