	...
	while true do Citizen.Wait(1)
		...
		if(IsPedInAnyVehicle(MyPed, false))then
			...
			if HUD.SpeedIndicator then
				drawRct(UI.x + 0.105, 	UI.y + 0.8755, 0.046,0.03,0,0,0,150) -- Speed panel
				if HUD.Speed == 'kmh' then
				...
				elseif HUD.Speed == 'mph' then
					drawTxt(UI.x + 0.606, 	UI.y + 1.364, 1.0,1.0,0.64 , "~w~" .. math.ceil(Speed), 255, 255, 255, 255)
					drawTxt(UI.x + 0.627, 	UI.y + 1.372, 1.0,1.0,0.4, "~w~ mph", 255, 255, 255, 255)
				else
